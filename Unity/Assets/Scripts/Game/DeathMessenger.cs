...
public class DeathMessenger : MonoBehaviour {
	...
	void Start () {
		...
		_verbs = new []{"ATE", "WHACKED", "SHANKED", "SLAPPED", "JUDGED", "ELBOWED", "ELIMINATED", "DESTROYED", "REMOVED", "RENOVATED",
                        ...
                        "ADDITIONAL PYLONS", "FRIDGED", "OBAMA'D", "IGDAM'D", "GGJ'D", "LOKI'D", "SMASHED", "KILLED", "DUELLED", "BESMIRCHED", "FONDLED", "PUT IN THEIR PLACE",
                        "RICKROLLED", "NAN", "STORMED OUT", "SCOOPED", "TRADED IN", "TAKEN TO THE POOL", "DAMPENED", "TWEETED", "SNIFFED", "FACEPLANTED", "ECSCAVATED", "TWERKED", "PLANKED", "TANKED"
